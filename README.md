...
- Redes de creencia profunda (Deep Belief Networks) con Máquinas de Boltzmann restringidas (Restricted Boltzmann Machine): una red de creencia profunda está formada por  of a Restricted Boltzmann Machine (RBM). 
