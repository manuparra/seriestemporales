...
* [Series Temporales](#series-temporales)
	...
	* [Análisis de series temporales univariantes](#análisis-de-series-temporales-univariantes)
		...
		* [Predicción de series temporales con deep learning](#predicción-de-series-temporales-con-deep-learning)
...
Cálculo (identificación) automático del mejor modelo ARIMA al que se ajustan los datos (se puede usar por ejemplo simplemente como una primera aproximación)(lo ideal es usarlo con la serie ya una vez sea estacionaria): 
